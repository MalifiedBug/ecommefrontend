...
const Login = () => {
  ...
  return (
    <div className='px-4 w-full h-screen flex justify-center items-center bg-login bg-no-repeat bg-cover'>
      <p className='text-white text-xl'>Test user id: <span className='text-sky-500'>mor_2314</span></p>
      <p className='text-white text-xl'>Test Password: <span className='text-sky-300'>83r5^_</span></p>
      <form
